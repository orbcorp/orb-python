...
- <code title="get /invoices/{invoice_id}">client.invoices.<a href="./src/orb/resources/invoices.py">fetch</a>(invoice_id, \*\*<a href="src/orb/types/invoice_fetch_params.py">params</a>) -> <a href="./src/orb/types/shared/invoice.py">Invoice</a></code>
