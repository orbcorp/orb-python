...
class Prices(SyncAPIResource):
    ...
    def create(
        self,
        *,
        cadence: Literal["annual", "monthly", "quarterly"],
        currency: str,
        item_id: str,
        model_type: Literal["unit"],
        name: str,
        unit_config: price_create_params.NewUnitPriceUnitConfig,
    ...
    def create(
        ...
        *,
        ...
        name: str,
        package_config: price_create_params.NewPackagePricePackageConfig,
        billable_metric_id: Optional[str] | NotGiven = NOT_GIVEN,
        billed_in_advance: Optional[bool] | NotGiven = NOT_GIVEN,
        external_price_id: Optional[str] | NotGiven = NOT_GIVEN,
        fixed_price_quantity: Optional[float] | NotGiven = NOT_GIVEN,
    ...
    def create(
        ...
        *,
        ...
        currency: str,
        item_id: str,
        matrix_config: price_create_params.NewMatrixPriceMatrixConfig,
    ...
    def create(
        ...
        *,
        ...
        name: str,
        tiered_config: price_create_params.NewTieredPriceTieredConfig,
        billable_metric_id: Optional[str] | NotGiven = NOT_GIVEN,
        billed_in_advance: Optional[bool] | NotGiven = NOT_GIVEN,
        external_price_id: Optional[str] | NotGiven = NOT_GIVEN,
        fixed_price_quantity: Optional[float] | NotGiven = NOT_GIVEN,
    ...
    def create(
        ...
        *,
        ...
        name: str,
        tiered_bps_config: price_create_params.NewTieredBpsPriceTieredBpsConfig,
        billable_metric_id: Optional[str] | NotGiven = NOT_GIVEN,
        billed_in_advance: Optional[bool] | NotGiven = NOT_GIVEN,
        external_price_id: Optional[str] | NotGiven = NOT_GIVEN,
        fixed_price_quantity: Optional[float] | NotGiven = NOT_GIVEN,
    ...
    def create(
        self,
        *,
        bps_config: price_create_params.NewBpsPriceBpsConfig,
        cadence: Literal["annual", "monthly", "quarterly"],
        currency: str,
        item_id: str,
    ...
    def create(
        self,
        *,
        bulk_bps_config: price_create_params.NewBulkBpsPriceBulkBpsConfig,
        cadence: Literal["annual", "monthly", "quarterly"],
        currency: str,
        item_id: str,
    ...
    def create(
        self,
        *,
        bulk_config: price_create_params.NewBulkPriceBulkConfig,
        cadence: Literal["annual", "monthly", "quarterly"],
        currency: str,
        item_id: str,
    ...
    def create(
        ...
        *,
        ...
        name: str,
        unit_config: price_create_params.NewUnitPriceUnitConfig | NotGiven = NOT_GIVEN,
        billable_metric_id: Optional[str] | NotGiven = NOT_GIVEN,
        billed_in_advance: Optional[bool] | NotGiven = NOT_GIVEN,
        external_price_id: Optional[str] | NotGiven = NOT_GIVEN,
        fixed_price_quantity: Optional[float] | NotGiven = NOT_GIVEN,
        invoice_grouping_key: Optional[str] | NotGiven = NOT_GIVEN,
        package_config: price_create_params.NewPackagePricePackageConfig | NotGiven = NOT_GIVEN,
        matrix_config: price_create_params.NewMatrixPriceMatrixConfig | NotGiven = NOT_GIVEN,
        tiered_config: price_create_params.NewTieredPriceTieredConfig | NotGiven = NOT_GIVEN,
        tiered_bps_config: price_create_params.NewTieredBpsPriceTieredBpsConfig | NotGiven = NOT_GIVEN,
        bps_config: price_create_params.NewBpsPriceBpsConfig | NotGiven = NOT_GIVEN,
        bulk_bps_config: price_create_params.NewBulkBpsPriceBulkBpsConfig | NotGiven = NOT_GIVEN,
        bulk_config: price_create_params.NewBulkPriceBulkConfig | NotGiven = NOT_GIVEN,
