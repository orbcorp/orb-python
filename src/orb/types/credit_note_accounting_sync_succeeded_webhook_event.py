...
__all__ = ["CreditNoteAccountingSyncSucceededWebhookEvent", "AccountingSyncRecord", "Properties"]
...
class CreditNoteAccountingSyncSucceededWebhookEvent(BaseModel):
    ...
    type: Literal["credit_note.accounting_sync_succeeded"]
