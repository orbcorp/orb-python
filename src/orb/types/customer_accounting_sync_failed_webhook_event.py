...
__all__ = ["CustomerAccountingSyncFailedWebhookEvent", "AccountingSyncRecord", "Properties"]
...
class CustomerAccountingSyncFailedWebhookEvent(BaseModel):
    ...
    type: Literal["customer.accounting_sync_failed"]
