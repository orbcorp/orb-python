...
class Properties(BaseModel):
    ...
    pricing_unit: Optional[PropertiesPricingUnit] = None
    """A currency or custom credit unit, as embedded in webhook payloads."""


class CustomerCreditBalanceRecoveredWebhookEvent(BaseModel):
    ...
    type: Literal["customer.credit_balance_recovered"]
