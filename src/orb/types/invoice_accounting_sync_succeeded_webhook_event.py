...
__all__ = ["InvoiceAccountingSyncSucceededWebhookEvent", "AccountingSyncRecord", "Properties"]
...
class InvoiceAccountingSyncSucceededWebhookEvent(BaseModel):
    ...
    type: Literal["invoice.accounting_sync_succeeded"]
