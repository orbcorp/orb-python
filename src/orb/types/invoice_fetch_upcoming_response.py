...
__all__ = [
    ...
    "LineItemAdjustmentMonetaryTieredPercentageDiscountAdjustmentFilter",
    "LineItemAdjustmentMonetaryTieredPercentageDiscountAdjustmentTier",
    "LineItemSubLineItem",
    "PaymentAttempt",
]
...
class LineItemAdjustmentMonetaryTieredPercentageDiscountAdjustmentFilter(BaseModel):
...
class LineItemAdjustmentMonetaryTieredPercentageDiscountAdjustmentTier(BaseModel):
...
class LineItemAdjustmentMonetaryTieredPercentageDiscountAdjustment(BaseModel):
    id: str
    ...
    filters: List[LineItemAdjustmentMonetaryTieredPercentageDiscountAdjustmentFilter]
    ...
    tiers: List[LineItemAdjustmentMonetaryTieredPercentageDiscountAdjustmentTier]
    """
