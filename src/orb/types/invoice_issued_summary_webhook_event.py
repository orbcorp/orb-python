...
class InvoiceAutoCollection(BaseModel):
...
class InvoiceCreditNote(BaseModel):
    id: str
...
class InvoiceCustomerBalanceTransaction(BaseModel):
    id: str
...
class Invoice(BaseModel):
    ...
    auto_collection: InvoiceAutoCollection
    ...
    customer_balance_transactions: List[InvoiceCustomerBalanceTransaction]
    ...
    payment_attempts: List[InvoicePaymentAttempt]
...
class InvoiceIssuedSummaryWebhookEvent(BaseModel):
    """
    ...
    type: Literal["invoice.issued_summary"]
