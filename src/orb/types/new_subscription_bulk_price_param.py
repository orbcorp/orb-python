...
__all__ = ["NewSubscriptionBulkPriceParam", "UnnamedTypeWithobjectParent165"]

UnnamedTypeWithobjectParent165: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionBulkPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent165]
