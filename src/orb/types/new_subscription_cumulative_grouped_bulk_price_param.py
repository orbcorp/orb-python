...
__all__ = ["NewSubscriptionCumulativeGroupedBulkPriceParam", "UnnamedTypeWithobjectParent167"]

UnnamedTypeWithobjectParent167: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionCumulativeGroupedBulkPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent167]
