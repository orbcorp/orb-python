...
__all__ = ["NewSubscriptionGroupedWithProratedMinimumPriceParam", "UnnamedTypeWithobjectParent178"]

UnnamedTypeWithobjectParent178: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionGroupedWithProratedMinimumPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent178]
