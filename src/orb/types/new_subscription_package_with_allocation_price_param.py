...
__all__ = ["NewSubscriptionPackageWithAllocationPriceParam", "UnnamedTypeWithobjectParent184"]

UnnamedTypeWithobjectParent184: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionPackageWithAllocationPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent184]
