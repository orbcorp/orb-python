...
__all__ = ["NewSubscriptionScalableMatrixWithTieredPricingPriceParam", "UnnamedTypeWithobjectParent182"]

UnnamedTypeWithobjectParent182: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionScalableMatrixWithTieredPricingPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent182]
