...
__all__ = ["NewSubscriptionScalableMatrixWithTieredPricingPriceParam", "UnnamedTypeWithobjectParent185"]

UnnamedTypeWithobjectParent185: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionScalableMatrixWithTieredPricingPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent185]
