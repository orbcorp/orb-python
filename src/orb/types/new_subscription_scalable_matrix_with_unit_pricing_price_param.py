...
__all__ = ["NewSubscriptionScalableMatrixWithUnitPricingPriceParam", "UnnamedTypeWithobjectParent183"]

UnnamedTypeWithobjectParent183: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionScalableMatrixWithUnitPricingPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent183]
