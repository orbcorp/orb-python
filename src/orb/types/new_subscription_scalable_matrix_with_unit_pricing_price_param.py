...
__all__ = ["NewSubscriptionScalableMatrixWithUnitPricingPriceParam", "UnnamedTypeWithobjectParent186"]

UnnamedTypeWithobjectParent186: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionScalableMatrixWithUnitPricingPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent186]
