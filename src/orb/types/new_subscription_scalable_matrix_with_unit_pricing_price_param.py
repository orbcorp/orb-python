...
__all__ = ["NewSubscriptionScalableMatrixWithUnitPricingPriceParam", "UnnamedTypeWithobjectParent181"]

UnnamedTypeWithobjectParent181: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
