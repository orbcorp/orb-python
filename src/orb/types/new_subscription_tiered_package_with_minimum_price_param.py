...
__all__ = ["NewSubscriptionTieredPackageWithMinimumPriceParam", "UnnamedTypeWithobjectParent187"]

UnnamedTypeWithobjectParent187: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionTieredPackageWithMinimumPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent187]
