...
__all__ = ["NewSubscriptionUnitWithPercentPriceParam", "UnnamedTypeWithobjectParent195"]

UnnamedTypeWithobjectParent195: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionUnitWithPercentPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent195]
