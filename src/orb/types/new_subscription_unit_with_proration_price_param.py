...
__all__ = ["NewSubscriptionUnitWithProrationPriceParam", "UnnamedTypeWithobjectParent192"]

UnnamedTypeWithobjectParent192: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionUnitWithProrationPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent192]
