...
__all__ = ["NewSubscriptionUnitWithProrationPriceParam", "UnnamedTypeWithobjectParent196"]

UnnamedTypeWithobjectParent196: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewSubscriptionUnitWithProrationPriceParam(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent196]
