...
__all__ = ["NewSubscriptionUnitWithProrationPriceParam", "UnnamedTypeWithobjectParent190"]

UnnamedTypeWithobjectParent190: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
