...
__all__ = [
    ...
    "PricePriceNewPlanGroupedTieredMatrixPrice",
    "PricePriceNewPlanGroupedTieredMatrixPriceGroupedTieredMatrixConfig",
    ...
    "PricePriceNewPlanTieredMatrixWithAllocationPrice",
    "PricePriceNewPlanTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfig",
    "PricePriceNewPlanTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier",
    "PricePriceNewPlanTieredMatrixWithAllocationPriceConversionRateConfig",
...
class PricePriceNewPlanGroupedTieredMatrixPriceGroupedTieredMatrixConfigTier(TypedDict, total=False):
...
class PricePriceNewPlanGroupedTieredMatrixPriceGroupedTieredMatrixConfig(TypedDict, total=False):
    ...
    tiers: Required[Iterable[PricePriceNewPlanGroupedTieredMatrixPriceGroupedTieredMatrixConfigTier]]
    """
...
PricePriceNewPlanGroupedTieredMatrixPriceConversionRateConfig: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]
...
class PricePriceNewPlanGroupedTieredMatrixPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[PricePriceNewPlanGroupedTieredMatrixPriceConversionRateConfig]
    """The configuration for the rate of the price currency to the invoicing currency."""
...
class PricePriceNewPlanTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier(TypedDict, total=False):
...
class PricePriceNewPlanTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfig(TypedDict, total=False):
    ...
    tiers: Required[Iterable[PricePriceNewPlanTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier]]
    """
...
PricePriceNewPlanTieredMatrixWithAllocationPriceConversionRateConfig: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]
...
class PricePriceNewPlanTieredMatrixWithAllocationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[PricePriceNewPlanTieredMatrixWithAllocationPriceConversionRateConfig]
    """The configuration for the rate of the price currency to the invoicing currency."""
