...
__all__ = [
    ...
    "NewFloatingGroupedTieredMatrixPrice",
    "NewFloatingGroupedTieredMatrixPriceGroupedTieredMatrixConfig",
    "NewFloatingGroupedTieredMatrixPriceGroupedTieredMatrixConfigTier",
    "NewFloatingGroupedTieredMatrixPriceConversionRateConfig",
    ...
    "NewFloatingTieredMatrixWithAllocationPrice",
    "NewFloatingTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfig",
    "NewFloatingTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier",
    "NewFloatingTieredMatrixWithAllocationPriceConversionRateConfig",
...
class NewFloatingGroupedTieredMatrixPrice(TypedDict, total=False):
    ...
    grouped_tiered_matrix_config: Required[NewFloatingGroupedTieredMatrixPriceGroupedTieredMatrixConfig]
    ...
    conversion_rate_config: Optional[NewFloatingGroupedTieredMatrixPriceConversionRateConfig]
    """The configuration for the rate of the price currency to the invoicing currency."""
...
class NewFloatingGroupedTieredMatrixPriceGroupedTieredMatrixConfigTier(TypedDict, total=False):
...
class NewFloatingGroupedTieredMatrixPriceGroupedTieredMatrixConfig(TypedDict, total=False):
    """Configuration for grouped_tiered_matrix pricing"""
    ...
    tiers: Required[Iterable[NewFloatingGroupedTieredMatrixPriceGroupedTieredMatrixConfigTier]]
    """
...
NewFloatingGroupedTieredMatrixPriceConversionRateConfig: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]
...
class NewFloatingTieredMatrixWithAllocationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[NewFloatingTieredMatrixWithAllocationPriceConversionRateConfig]
    """The configuration for the rate of the price currency to the invoicing currency."""
...
class NewFloatingTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier(TypedDict, total=False):
...
class NewFloatingTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfig(TypedDict, total=False):
    """Configuration for tiered_matrix_with_allocation pricing"""
    ...
    tiers: Required[Iterable[NewFloatingTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier]]
    """
...
NewFloatingTieredMatrixWithAllocationPriceConversionRateConfig: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]
