...
__all__ = [
    ...
    "PriceEvaluationPriceNewFloatingGroupedWithMinMaxThresholdsPriceUnnamedTypeWithobjectParent166",
    "PriceEvaluationPriceNewFloatingMinimumCompositePrice",
    "PriceEvaluationPriceNewFloatingMinimumCompositePriceMinimumConfig",
    "PriceEvaluationPriceNewFloatingMinimumCompositePriceUnnamedTypeWithobjectParent167",
]
...
PriceEvaluationPriceNewFloatingGroupedWithMinMaxThresholdsPriceUnnamedTypeWithobjectParent166: TypeAlias = Union[
...
class PriceEvaluationPriceNewFloatingMinimumCompositePriceMinimumConfig(TypedDict, total=False):
...
PriceEvaluationPriceNewFloatingMinimumCompositePriceUnnamedTypeWithobjectParent167: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]


class PriceEvaluationPriceNewFloatingMinimumCompositePrice(TypedDict, total=False):
    cadence: Required[Literal["annual", "semi_annual", "monthly", "quarterly", "one_time", "custom"]]
    """The cadence to bill for this price on."""
    ...
    minimum_config: Required[PriceEvaluationPriceNewFloatingMinimumCompositePriceMinimumConfig]
    ...
    conversion_rate_config: Optional[PriceEvaluationPriceNewFloatingMinimumCompositePriceUnnamedTypeWithobjectParent167]
    """The configuration for the rate of the price currency to the invoicing currency."""
