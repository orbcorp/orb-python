...
__all__ = ["SalesOrderAccountingSyncFailedWebhookEvent", "AccountingSyncRecord", "Properties"]
...
class SalesOrderAccountingSyncFailedWebhookEvent(BaseModel):
    ...
    type: Literal["sales_order.accounting_sync_failed"]
