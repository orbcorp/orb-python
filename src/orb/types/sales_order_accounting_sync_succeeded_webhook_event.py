...
__all__ = ["SalesOrderAccountingSyncSucceededWebhookEvent", "AccountingSyncRecord", "Properties"]
...
class SalesOrderAccountingSyncSucceededWebhookEvent(BaseModel):
    ...
    type: Literal["sales_order.accounting_sync_succeeded"]
