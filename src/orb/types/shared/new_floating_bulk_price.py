...
__all__ = ["NewFloatingBulkPrice", "UnnamedTypeWithobjectParent27"]

UnnamedTypeWithobjectParent27: TypeAlias = Annotated[
...
class NewFloatingBulkPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent27] = None
