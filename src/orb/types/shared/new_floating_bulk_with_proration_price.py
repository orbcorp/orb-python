...
__all__ = ["NewFloatingBulkWithProrationPrice", "UnnamedTypeWithobjectParent28"]

UnnamedTypeWithobjectParent28: TypeAlias = Annotated[
...
class NewFloatingBulkWithProrationPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent28] = None
