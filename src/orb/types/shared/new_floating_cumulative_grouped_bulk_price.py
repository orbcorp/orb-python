...
__all__ = ["NewFloatingCumulativeGroupedBulkPrice", "UnnamedTypeWithobjectParent32"]

UnnamedTypeWithobjectParent32: TypeAlias = Annotated[
...
class NewFloatingCumulativeGroupedBulkPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent32] = None
