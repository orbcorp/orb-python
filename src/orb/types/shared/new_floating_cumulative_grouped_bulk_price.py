...
__all__ = ["NewFloatingCumulativeGroupedBulkPrice", "UnnamedTypeWithobjectParent29"]

UnnamedTypeWithobjectParent29: TypeAlias = Annotated[
...
class NewFloatingCumulativeGroupedBulkPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent29] = None
