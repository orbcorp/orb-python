...
__all__ = ["NewFloatingGroupedAllocationPrice", "UnnamedTypeWithobjectParent30"]

UnnamedTypeWithobjectParent30: TypeAlias = Annotated[
...
class NewFloatingGroupedAllocationPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent30] = None
