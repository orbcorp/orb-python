...
__all__ = ["NewFloatingGroupedTieredPackagePrice", "UnnamedTypeWithobjectParent31"]

UnnamedTypeWithobjectParent31: TypeAlias = Annotated[
...
class NewFloatingGroupedTieredPackagePrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent31] = None
