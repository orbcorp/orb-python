...
__all__ = ["NewFloatingGroupedWithProratedMinimumPrice", "UnnamedTypeWithobjectParent37"]

UnnamedTypeWithobjectParent37: TypeAlias = Annotated[
...
class NewFloatingGroupedWithProratedMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent37] = None
