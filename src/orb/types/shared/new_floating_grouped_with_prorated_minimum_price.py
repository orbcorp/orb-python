...
__all__ = ["NewFloatingGroupedWithProratedMinimumPrice", "UnnamedTypeWithobjectParent34"]

UnnamedTypeWithobjectParent34: TypeAlias = Annotated[
...
class NewFloatingGroupedWithProratedMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent34] = None
