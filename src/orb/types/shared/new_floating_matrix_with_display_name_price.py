...
__all__ = ["NewFloatingMatrixWithDisplayNamePrice", "UnnamedTypeWithobjectParent40"]

UnnamedTypeWithobjectParent40: TypeAlias = Annotated[
...
class NewFloatingMatrixWithDisplayNamePrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent40] = None
