...
__all__ = ["NewFloatingMaxGroupTieredPackagePrice", "UnnamedTypeWithobjectParent38"]

UnnamedTypeWithobjectParent38: TypeAlias = Annotated[
...
class NewFloatingMaxGroupTieredPackagePrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent38] = None
