...
__all__ = ["NewFloatingScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent41"]

UnnamedTypeWithobjectParent41: TypeAlias = Annotated[
...
class NewFloatingScalableMatrixWithTieredPricingPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent41] = None
