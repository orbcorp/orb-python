...
__all__ = ["NewFloatingScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent42"]

UnnamedTypeWithobjectParent42: TypeAlias = Annotated[
...
class NewFloatingScalableMatrixWithTieredPricingPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent42] = None
