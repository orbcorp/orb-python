...
__all__ = ["NewFloatingTieredPackageWithMinimumPrice", "UnnamedTypeWithobjectParent46"]

UnnamedTypeWithobjectParent46: TypeAlias = Annotated[
...
class NewFloatingTieredPackageWithMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent46] = None
