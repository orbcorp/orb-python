...
__all__ = ["NewFloatingTieredWithMinimumPrice", "UnnamedTypeWithobjectParent47"]

UnnamedTypeWithobjectParent47: TypeAlias = Annotated[
...
class NewFloatingTieredWithMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent47] = None
