...
__all__ = ["NewFloatingTieredWithMinimumPrice", "UnnamedTypeWithobjectParent51"]

UnnamedTypeWithobjectParent51: TypeAlias = Annotated[
...
class NewFloatingTieredWithMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent51] = None
