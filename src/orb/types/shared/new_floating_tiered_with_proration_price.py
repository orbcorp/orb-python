...
__all__ = ["NewFloatingTieredWithProrationPrice", "UnnamedTypeWithobjectParent48"]

UnnamedTypeWithobjectParent48: TypeAlias = Annotated[
...
class NewFloatingTieredWithProrationPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent48] = None
