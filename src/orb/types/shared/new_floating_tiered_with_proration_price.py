...
__all__ = ["NewFloatingTieredWithProrationPrice", "UnnamedTypeWithobjectParent52"]

UnnamedTypeWithobjectParent52: TypeAlias = Annotated[
...
class NewFloatingTieredWithProrationPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent52] = None
