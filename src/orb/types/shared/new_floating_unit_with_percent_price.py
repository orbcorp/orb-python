...
__all__ = ["NewFloatingUnitWithPercentPrice", "UnnamedTypeWithobjectParent50"]

UnnamedTypeWithobjectParent50: TypeAlias = Annotated[
...
class NewFloatingUnitWithPercentPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent50] = None
