...
__all__ = ["NewPlanCumulativeGroupedBulkPrice", "UnnamedTypeWithobjectParent55"]

UnnamedTypeWithobjectParent55: TypeAlias = Annotated[
...
class NewPlanCumulativeGroupedBulkPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent55] = None
