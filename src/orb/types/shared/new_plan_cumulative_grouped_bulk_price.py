...
__all__ = ["NewPlanCumulativeGroupedBulkPrice", "UnnamedTypeWithobjectParent54"]

UnnamedTypeWithobjectParent54: TypeAlias = Annotated[
...
class NewPlanCumulativeGroupedBulkPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent54] = None
