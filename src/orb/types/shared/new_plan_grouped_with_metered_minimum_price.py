...
__all__ = ["NewPlanGroupedWithMeteredMinimumPrice", "UnnamedTypeWithobjectParent58"]

UnnamedTypeWithobjectParent58: TypeAlias = Annotated[
...
class NewPlanGroupedWithMeteredMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent58] = None
