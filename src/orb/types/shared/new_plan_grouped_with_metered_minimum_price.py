...
__all__ = ["NewPlanGroupedWithMeteredMinimumPrice", "UnnamedTypeWithobjectParent64"]

UnnamedTypeWithobjectParent64: TypeAlias = Annotated[
...
class NewPlanGroupedWithMeteredMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent64] = None
