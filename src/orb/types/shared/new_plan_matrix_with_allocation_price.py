...
__all__ = ["NewPlanMatrixWithAllocationPrice", "UnnamedTypeWithobjectParent61"]

UnnamedTypeWithobjectParent61: TypeAlias = Annotated[
...
class NewPlanMatrixWithAllocationPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent61] = None
