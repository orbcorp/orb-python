...
__all__ = ["NewPlanMatrixWithDisplayNamePrice", "UnnamedTypeWithobjectParent62"]

UnnamedTypeWithobjectParent62: TypeAlias = Annotated[
...
class NewPlanMatrixWithDisplayNamePrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent62] = None
