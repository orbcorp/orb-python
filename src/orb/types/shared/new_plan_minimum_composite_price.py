...
__all__ = ["NewPlanMinimumCompositePrice", "MinimumConfig", "UnnamedTypeWithobjectParent65"]
...
class NewPlanMinimumCompositePrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent65] = None
