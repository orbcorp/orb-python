...
__all__ = ["NewPlanScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent72"]

UnnamedTypeWithobjectParent72: TypeAlias = Annotated[
...
class NewPlanScalableMatrixWithTieredPricingPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent72] = None
