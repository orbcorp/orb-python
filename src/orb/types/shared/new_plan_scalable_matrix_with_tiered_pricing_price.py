...
__all__ = ["NewPlanScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent66"]

UnnamedTypeWithobjectParent66: TypeAlias = Annotated[
...
class NewPlanScalableMatrixWithTieredPricingPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent66] = None
