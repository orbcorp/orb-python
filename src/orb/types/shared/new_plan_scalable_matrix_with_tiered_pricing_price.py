...
__all__ = ["NewPlanScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent68"]

UnnamedTypeWithobjectParent68: TypeAlias = Annotated[
...
class NewPlanScalableMatrixWithTieredPricingPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent68] = None
