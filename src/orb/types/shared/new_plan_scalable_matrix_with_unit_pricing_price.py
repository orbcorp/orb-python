...
__all__ = ["NewPlanScalableMatrixWithUnitPricingPrice", "UnnamedTypeWithobjectParent67"]

UnnamedTypeWithobjectParent67: TypeAlias = Annotated[
...
class NewPlanScalableMatrixWithUnitPricingPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent67] = None
