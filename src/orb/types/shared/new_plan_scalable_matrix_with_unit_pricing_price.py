...
__all__ = ["NewPlanScalableMatrixWithUnitPricingPrice", "UnnamedTypeWithobjectParent73"]

UnnamedTypeWithobjectParent73: TypeAlias = Annotated[
...
class NewPlanScalableMatrixWithUnitPricingPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent73] = None
