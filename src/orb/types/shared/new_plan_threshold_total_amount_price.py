...
__all__ = ["NewPlanThresholdTotalAmountPrice", "UnnamedTypeWithobjectParent74"]

UnnamedTypeWithobjectParent74: TypeAlias = Annotated[
...
class NewPlanThresholdTotalAmountPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent74] = None
