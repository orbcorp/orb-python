...
__all__ = ["NewPlanTieredPackageWithMinimumPrice", "UnnamedTypeWithobjectParent71"]

UnnamedTypeWithobjectParent71: TypeAlias = Annotated[
...
class NewPlanTieredPackageWithMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent71] = None
