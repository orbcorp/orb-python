...
__all__ = ["NewPlanTieredPackageWithMinimumPrice", "UnnamedTypeWithobjectParent78"]

UnnamedTypeWithobjectParent78: TypeAlias = Annotated[
...
class NewPlanTieredPackageWithMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent78] = None
