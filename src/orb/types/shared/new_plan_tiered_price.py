...
__all__ = ["NewPlanTieredPrice", "UnnamedTypeWithobjectParent79"]

UnnamedTypeWithobjectParent79: TypeAlias = Annotated[
...
class NewPlanTieredPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent79] = None
