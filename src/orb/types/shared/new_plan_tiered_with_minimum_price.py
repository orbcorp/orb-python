...
__all__ = ["NewPlanTieredWithMinimumPrice", "UnnamedTypeWithobjectParent80"]

UnnamedTypeWithobjectParent80: TypeAlias = Annotated[
...
class NewPlanTieredWithMinimumPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent80] = None
