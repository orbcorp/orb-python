...
__all__ = ["NewPlanUnitWithPercentPrice", "UnnamedTypeWithobjectParent77"]

UnnamedTypeWithobjectParent77: TypeAlias = Annotated[
...
class NewPlanUnitWithPercentPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent77] = None
