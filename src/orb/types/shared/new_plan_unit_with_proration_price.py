...
__all__ = ["NewPlanUnitWithProrationPrice", "UnnamedTypeWithobjectParent83"]

UnnamedTypeWithobjectParent83: TypeAlias = Annotated[
...
class NewPlanUnitWithProrationPrice(BaseModel):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent83] = None
