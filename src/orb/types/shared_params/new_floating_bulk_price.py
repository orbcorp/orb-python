...
__all__ = ["NewFloatingBulkPrice", "UnnamedTypeWithobjectParent104"]

UnnamedTypeWithobjectParent104: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingBulkPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent104]
