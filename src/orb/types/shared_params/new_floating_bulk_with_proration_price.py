...
__all__ = ["NewFloatingBulkWithProrationPrice", "UnnamedTypeWithobjectParent105"]

UnnamedTypeWithobjectParent105: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingBulkWithProrationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent105]
