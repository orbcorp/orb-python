...
__all__ = ["NewFloatingBulkWithProrationPrice", "UnnamedTypeWithobjectParent107"]

UnnamedTypeWithobjectParent107: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingBulkWithProrationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent107]
