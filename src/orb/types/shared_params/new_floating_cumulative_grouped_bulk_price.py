...
__all__ = ["NewFloatingCumulativeGroupedBulkPrice", "UnnamedTypeWithobjectParent106"]

UnnamedTypeWithobjectParent106: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingCumulativeGroupedBulkPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent106]
