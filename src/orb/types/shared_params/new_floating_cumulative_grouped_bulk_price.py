...
__all__ = ["NewFloatingCumulativeGroupedBulkPrice", "UnnamedTypeWithobjectParent108"]

UnnamedTypeWithobjectParent108: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingCumulativeGroupedBulkPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent108]
