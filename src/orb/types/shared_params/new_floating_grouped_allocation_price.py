...
__all__ = ["NewFloatingGroupedAllocationPrice", "UnnamedTypeWithobjectParent109"]

UnnamedTypeWithobjectParent109: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
