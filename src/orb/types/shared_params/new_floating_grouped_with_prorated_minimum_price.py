...
__all__ = ["NewFloatingGroupedWithProratedMinimumPrice", "UnnamedTypeWithobjectParent111"]

UnnamedTypeWithobjectParent111: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingGroupedWithProratedMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent111]
