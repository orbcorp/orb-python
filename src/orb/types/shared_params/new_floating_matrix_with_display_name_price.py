...
__all__ = ["NewFloatingMatrixWithDisplayNamePrice", "UnnamedTypeWithobjectParent114"]

UnnamedTypeWithobjectParent114: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingMatrixWithDisplayNamePrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent114]
