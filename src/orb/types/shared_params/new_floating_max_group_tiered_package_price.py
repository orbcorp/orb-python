...
__all__ = ["NewFloatingMaxGroupTieredPackagePrice", "UnnamedTypeWithobjectParent117"]

UnnamedTypeWithobjectParent117: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingMaxGroupTieredPackagePrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent117]
