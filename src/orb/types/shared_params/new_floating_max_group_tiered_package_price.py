...
__all__ = ["NewFloatingMaxGroupTieredPackagePrice", "UnnamedTypeWithobjectParent126"]

UnnamedTypeWithobjectParent126: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingMaxGroupTieredPackagePrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent126]
