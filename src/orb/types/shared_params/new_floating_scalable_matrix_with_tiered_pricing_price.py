...
__all__ = ["NewFloatingScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent129"]

UnnamedTypeWithobjectParent129: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingScalableMatrixWithTieredPricingPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent129]
