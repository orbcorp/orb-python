...
__all__ = ["NewFloatingThresholdTotalAmountPrice", "UnnamedTypeWithobjectParent131"]

UnnamedTypeWithobjectParent131: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingThresholdTotalAmountPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent131]
