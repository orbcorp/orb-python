...
__all__ = ["NewFloatingTieredPackageWithMinimumPrice", "UnnamedTypeWithobjectParent134"]

UnnamedTypeWithobjectParent134: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingTieredPackageWithMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent134]
