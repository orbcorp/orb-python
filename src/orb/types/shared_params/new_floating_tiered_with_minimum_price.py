...
__all__ = ["NewFloatingTieredWithMinimumPrice", "UnnamedTypeWithobjectParent127"]

UnnamedTypeWithobjectParent127: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingTieredWithMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent127]
