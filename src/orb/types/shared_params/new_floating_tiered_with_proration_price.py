...
__all__ = ["NewFloatingTieredWithProrationPrice", "UnnamedTypeWithobjectParent137"]

UnnamedTypeWithobjectParent137: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewFloatingTieredWithProrationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent137]
