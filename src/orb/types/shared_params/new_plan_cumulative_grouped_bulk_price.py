...
__all__ = ["NewPlanCumulativeGroupedBulkPrice", "UnnamedTypeWithobjectParent145"]

UnnamedTypeWithobjectParent145: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanCumulativeGroupedBulkPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent145]
