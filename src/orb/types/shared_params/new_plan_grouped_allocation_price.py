...
__all__ = ["NewPlanGroupedAllocationPrice", "UnnamedTypeWithobjectParent132"]

UnnamedTypeWithobjectParent132: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanGroupedAllocationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent132]
