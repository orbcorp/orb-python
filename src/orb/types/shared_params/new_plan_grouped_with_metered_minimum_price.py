...
__all__ = ["NewPlanGroupedWithMeteredMinimumPrice", "UnnamedTypeWithobjectParent149"]

UnnamedTypeWithobjectParent149: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanGroupedWithMeteredMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent149]
