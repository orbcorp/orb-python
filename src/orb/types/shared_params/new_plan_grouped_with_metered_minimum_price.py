...
__all__ = ["NewPlanGroupedWithMeteredMinimumPrice", "UnnamedTypeWithobjectParent135"]

UnnamedTypeWithobjectParent135: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanGroupedWithMeteredMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent135]
