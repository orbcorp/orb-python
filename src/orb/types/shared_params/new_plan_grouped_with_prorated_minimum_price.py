...
__all__ = ["NewPlanGroupedWithProratedMinimumPrice", "UnnamedTypeWithobjectParent150"]

UnnamedTypeWithobjectParent150: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanGroupedWithProratedMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent150]
