...
__all__ = ["NewPlanGroupedWithProratedMinimumPrice", "UnnamedTypeWithobjectParent139"]

UnnamedTypeWithobjectParent139: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanGroupedWithProratedMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent139]
