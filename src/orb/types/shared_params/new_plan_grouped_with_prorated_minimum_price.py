...
__all__ = ["NewPlanGroupedWithProratedMinimumPrice", "UnnamedTypeWithobjectParent136"]

UnnamedTypeWithobjectParent136: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
