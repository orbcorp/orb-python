...
__all__ = ["NewPlanMatrixWithAllocationPrice", "UnnamedTypeWithobjectParent141"]

UnnamedTypeWithobjectParent141: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanMatrixWithAllocationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent141]
