...
__all__ = ["NewPlanMatrixWithDisplayNamePrice", "UnnamedTypeWithobjectParent153"]

UnnamedTypeWithobjectParent153: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanMatrixWithDisplayNamePrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent153]
