...
__all__ = ["NewPlanPackagePrice", "UnnamedTypeWithobjectParent155"]

UnnamedTypeWithobjectParent155: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanPackagePrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent155]
