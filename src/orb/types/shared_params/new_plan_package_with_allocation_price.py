...
__all__ = ["NewPlanPackageWithAllocationPrice", "UnnamedTypeWithobjectParent142"]

UnnamedTypeWithobjectParent142: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanPackageWithAllocationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent142]
