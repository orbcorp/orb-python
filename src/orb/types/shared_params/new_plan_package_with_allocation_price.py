...
__all__ = ["NewPlanPackageWithAllocationPrice", "UnnamedTypeWithobjectParent156"]

UnnamedTypeWithobjectParent156: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanPackageWithAllocationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent156]
