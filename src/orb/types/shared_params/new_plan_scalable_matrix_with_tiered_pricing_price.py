...
__all__ = ["NewPlanScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent147"]

UnnamedTypeWithobjectParent147: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanScalableMatrixWithTieredPricingPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent147]
