...
__all__ = ["NewPlanScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent157"]

UnnamedTypeWithobjectParent157: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanScalableMatrixWithTieredPricingPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent157]
