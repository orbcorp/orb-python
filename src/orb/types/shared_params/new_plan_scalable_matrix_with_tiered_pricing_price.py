...
__all__ = ["NewPlanScalableMatrixWithTieredPricingPrice", "UnnamedTypeWithobjectParent143"]

UnnamedTypeWithobjectParent143: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanScalableMatrixWithTieredPricingPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent143]
