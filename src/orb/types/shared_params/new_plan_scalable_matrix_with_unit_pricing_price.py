...
__all__ = ["NewPlanScalableMatrixWithUnitPricingPrice", "UnnamedTypeWithobjectParent158"]

UnnamedTypeWithobjectParent158: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanScalableMatrixWithUnitPricingPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent158]
