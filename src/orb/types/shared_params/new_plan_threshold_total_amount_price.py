...
__all__ = ["NewPlanThresholdTotalAmountPrice", "UnnamedTypeWithobjectParent159"]

UnnamedTypeWithobjectParent159: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanThresholdTotalAmountPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent159]
