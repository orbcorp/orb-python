...
__all__ = ["NewPlanTierWithProrationPrice", "UnnamedTypeWithobjectParent146"]

UnnamedTypeWithobjectParent146: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanTierWithProrationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent146]
