...
__all__ = ["NewPlanTierWithProrationPrice", "UnnamedTypeWithobjectParent160"]

UnnamedTypeWithobjectParent160: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanTierWithProrationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent160]
