...
__all__ = ["NewPlanTieredBPSPrice", "UnnamedTypeWithobjectParent161"]

UnnamedTypeWithobjectParent161: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanTieredBPSPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent161]
