...
__all__ = ["NewPlanTieredPackagePrice", "UnnamedTypeWithobjectParent151"]

UnnamedTypeWithobjectParent151: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanTieredPackagePrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent151]
