...
__all__ = ["NewPlanTieredPackageWithMinimumPrice", "UnnamedTypeWithobjectParent163"]

UnnamedTypeWithobjectParent163: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanTieredPackageWithMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent163]
