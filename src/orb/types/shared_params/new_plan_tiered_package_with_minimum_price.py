...
__all__ = ["NewPlanTieredPackageWithMinimumPrice", "UnnamedTypeWithobjectParent152"]

UnnamedTypeWithobjectParent152: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanTieredPackageWithMinimumPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent152]
