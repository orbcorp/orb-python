...
__all__ = ["NewPlanTieredPackageWithMinimumPrice", "UnnamedTypeWithobjectParent148"]

UnnamedTypeWithobjectParent148: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
