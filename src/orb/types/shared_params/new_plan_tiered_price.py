...
__all__ = ["NewPlanTieredPrice", "UnnamedTypeWithobjectParent164"]

UnnamedTypeWithobjectParent164: TypeAlias = Union[UnitConversionRateConfig, TieredConversionRateConfig]
...
class NewPlanTieredPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[UnnamedTypeWithobjectParent164]
