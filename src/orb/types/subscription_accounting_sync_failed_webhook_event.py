...
__all__ = ["SubscriptionAccountingSyncFailedWebhookEvent", "AccountingSyncRecord", "Properties"]
...
class SubscriptionAccountingSyncFailedWebhookEvent(BaseModel):
    ...
    type: Literal["subscription.accounting_sync_failed"]
