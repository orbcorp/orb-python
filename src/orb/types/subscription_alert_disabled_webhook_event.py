...
class Properties(BaseModel):
    """
    Sent when the system disables an alert on its own, currently for cardinality-limit enforcement
    on grouped cost alerts.
    """
    ...
    reason: Literal["user", "system_cardinality_limit"]
...
class SubscriptionAlertDisabledWebhookEvent(BaseModel):
    ...
    type: Literal["subscription.alert_disabled"]
