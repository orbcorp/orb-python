...
__all__ = ["SubscriptionCancellationScheduledWebhookEvent", "Properties"]
...
class SubscriptionCancellationScheduledWebhookEvent(BaseModel):
    ...
    type: Literal["subscription.cancellation_scheduled"]
