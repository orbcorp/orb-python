...
__all__ = ["SubscriptionCancellationUnscheduledWebhookEvent", "Properties"]


class Properties(BaseModel):
    original_cancellation_date: str


class SubscriptionCancellationUnscheduledWebhookEvent(BaseModel):
    ...
    type: Literal["subscription.cancellation_unscheduled"]
