...
__all__ = [
    ...
    "AddPricePriceNewSubscriptionTieredMatrixWithAllocationPrice",
    "AddPricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfig",
    "AddPricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier",
    "AddPricePriceNewSubscriptionTieredMatrixWithAllocationPriceConversionRateConfig",
    ...
    "AddPricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceMatrixWithThresholdDiscountsConfigThresholdDiscountGroup",
    ...
    "ReplacePricePriceNewSubscriptionTieredMatrixWithAllocationPrice",
    "ReplacePricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfig",
    "ReplacePricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier",
    "ReplacePricePriceNewSubscriptionTieredMatrixWithAllocationPriceConversionRateConfig",
...
class AddPricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier(
...
class AddPricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfig(
    TypedDict, total=False
):
    ...
    tiers: Required[
        Iterable[AddPricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier]
    ]
    """
...
AddPricePriceNewSubscriptionTieredMatrixWithAllocationPriceConversionRateConfig: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]
...
class AddPricePriceNewSubscriptionTieredMatrixWithAllocationPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[AddPricePriceNewSubscriptionTieredMatrixWithAllocationPriceConversionRateConfig]
    """The configuration for the rate of the price currency to the invoicing currency."""
...
class AddPricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceMatrixWithThresholdDiscountsConfigMatrixValue(
    TypedDict, total=False
):
...
class AddPricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceMatrixWithThresholdDiscountsConfigThresholdDiscountGroup(
    TypedDict, total=False
):
...
class AddPricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceMatrixWithThresholdDiscountsConfig(
    TypedDict, total=False
):
...
AddPricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceConversionRateConfig: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]
...
class AddPricePriceNewSubscriptionMatrixWithThresholdDiscountsPrice(TypedDict, total=False):
    ...
    conversion_rate_config: Optional[AddPricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceConversionRateConfig]
    """The configuration for the rate of the price currency to the invoicing currency."""
...
class ReplacePricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier(
    TypedDict, total=False
):
    """Configuration for a single tier scoped to one matrix cell"""
...
class ReplacePricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfig(
    TypedDict, total=False
):
    """Configuration for tiered_matrix_with_allocation pricing"""
    ...
    tiers: Required[
        Iterable[ReplacePricePriceNewSubscriptionTieredMatrixWithAllocationPriceTieredMatrixWithAllocationConfigTier]
    ]
    """
    Graduated tiers keyed by matrix cell; usage in a cell is tiered only against its
    own rows
...
ReplacePricePriceNewSubscriptionTieredMatrixWithAllocationPriceConversionRateConfig: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]
...
class ReplacePricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceMatrixWithThresholdDiscountsConfigMatrixValue(
    TypedDict, total=False
):
    first_dimension_value: Required[str]
...
class ReplacePricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceMatrixWithThresholdDiscountsConfigThresholdDiscountGroup(
    TypedDict, total=False
):
    above_threshold_discount_percentage: Required[str]
    """Discount rate applied to spend above the threshold."""
...
class ReplacePricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceMatrixWithThresholdDiscountsConfig(
    TypedDict, total=False
):
    """Configuration for matrix_with_threshold_discounts pricing"""
...
ReplacePricePriceNewSubscriptionMatrixWithThresholdDiscountsPriceConversionRateConfig: TypeAlias = Union[
    UnitConversionRateConfig, TieredConversionRateConfig
]
