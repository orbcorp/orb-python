...
__all__ = ["SubscriptionFixedFeeQuantityUpdatedWebhookEvent", "Properties"]
...
class SubscriptionFixedFeeQuantityUpdatedWebhookEvent(BaseModel):
    ...
    type: Literal["subscription.fixed_fee_quantity_updated"]
