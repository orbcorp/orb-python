...
class PropertiesGroup(BaseModel):
    ...
    evaluated_amount: Optional[str] = None
...
class SubscriptionGroupedCostExceededWebhookEvent(BaseModel):
    """
    ...
    type: Literal["subscription.grouped_cost_exceeded"]
