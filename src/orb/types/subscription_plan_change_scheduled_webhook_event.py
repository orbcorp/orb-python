...
__all__ = ["SubscriptionPlanChangeScheduledWebhookEvent", "Properties"]
...
class SubscriptionPlanChangeScheduledWebhookEvent(BaseModel):
    ...
    type: Literal["subscription.plan_change_scheduled"]
