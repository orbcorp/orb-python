...
__all__ = ["SubscriptionPlanVersionChangeScheduledWebhookEvent", "Properties"]


class Properties(BaseModel):
    effective_date: str

    new_plan_version_number: int

    previous_plan_version_number: int


class SubscriptionPlanVersionChangeScheduledWebhookEvent(BaseModel):
    ...
    type: Literal["subscription.plan_version_change_scheduled"]
