...
__all__ = ["SubscriptionPlanVersionChangedWebhookEvent", "Properties"]
...
class SubscriptionPlanVersionChangedWebhookEvent(BaseModel):
    ...
    type: Literal["subscription.plan_version_changed"]
