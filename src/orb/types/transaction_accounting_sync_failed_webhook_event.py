...
__all__ = ["TransactionAccountingSyncFailedWebhookEvent", "AccountingSyncRecord", "Properties", "Transaction"]
...
class TransactionAccountingSyncFailedWebhookEvent(BaseModel):
    ...
    type: Literal["transaction.accounting_sync_failed"]
