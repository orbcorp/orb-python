...
class TestItems:
    ...
    def test_method_list(self, client: Orb) -> None:
        ...
        assert_matches_type(SyncPage[ItemListResponse], item, path=["response"])
    ...
    def test_method_fetch(self, client: Orb) -> None:
        ...
        assert_matches_type(ItemFetchResponse, item, path=["response"])
...
class TestAsyncItems:
    ...
    async def test_method_list(self, client: AsyncOrb) -> None:
        ...
        assert_matches_type(AsyncPage[ItemListResponse], item, path=["response"])
