...
class TestOrb:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Orb(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_omit_retry_count_header(self, client: Orb, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        response = client.customers.with_raw_response.create(
            email="email", name="x", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.customers.with_raw_response.create(
            email="email", name="x", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncOrb:
    ...
    def test_base_url_trailing_slash(self, client: AsyncOrb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncOrb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncOrb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncOrb(base_url=base_url, api_key=api_key, _strict_response_validation=False)
